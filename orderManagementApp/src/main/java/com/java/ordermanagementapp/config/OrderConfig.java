package com.java.ordermanagementapp.config;
...
//                .requestFactory(() -> disableSSL())
    ...
    private HttpComponentsClientHttpRequestFactory disableSSL(){
        TrustStrategy acceptingTrustStrategy = new TrustStrategy() {
            ...
            public boolean isTrusted(X509Certificate[] x509Certificates, String s) throws CertificateException {
                //Here we have to write validation logic
                return true;
            }
        };
    ...
    private HttpComponentsClientHttpRequestFactory validateSSL(){
        String location = "E:\\springboot-rest-service-ssl-mode\\registrationService\\ssl_server.jks";
        String pass = "rajeev";
        SSLContext sslContext = null;
        try{
